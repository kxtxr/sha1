...
private: 
    ...
    unsigned long int digest[DIGEST_INTS];
    std::string buffer;
...
void SHA1::transform(unsigned long int block[BLOCK_BYTES])
{
    ...
    unsigned long int a = digest[0];
    unsigned long int b = digest[1];
    unsigned long int c = digest[2];
    unsigned long int d = digest[3];
    unsigned long int e = digest[4];
